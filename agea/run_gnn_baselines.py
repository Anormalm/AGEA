#!/usr/bin/env python
"""Run GNN baselines only — no AGEA/GRPO."""
...
from models.classifier import (
    ...
    PMPClassifier, ConsisGADClassifier, GAAPClassifier,
)
...
def main():
    ...
    print(f"\n  Loading dataset: yelp_spam from {root}")
    ...
    # Print results table
    print(f"\n{'='*70}")
    print(f"GNN BASELINES: yelp_spam")
    print(f"{'='*70}")
